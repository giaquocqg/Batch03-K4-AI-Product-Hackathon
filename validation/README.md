...
2. **Hỏi đúng 3 câu:**
   ...
   - "Kết quả đối chiếu 60% và citation này bạn có tin không — vì sao?"
...
- Khi thử active recall, quan sát riêng việc người thử có hiểu vì sao câu được/chưa được 60% và có mở citation để kiểm tra phản hồi AI hay không.
