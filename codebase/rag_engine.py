...
def query_rag(query: str, transcript_id: str) -> dict:
    """
    Điểm truy cập chính cho RAG Chatbot.
    
    Args:
        query: Câu hỏi của học viên
    ...
    # Tìm kiếm các segments khớp nhất bằng Hybrid Search
    results = index.search_hybrid(query, top_k=4)
